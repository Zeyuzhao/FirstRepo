...
description: Upload an existing screenshot file to the Jiro session
---

# upload-screenshot

Use this skill when you already have a screenshot file on disk and need to upload it to the Jiro
session. The screenshot may have been captured by any source: Playwright MCP, `agent-browser`, a
manual file, or any other tool.
